...
class CloudBLETableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let nib = UINib(nibName: "BLEDataItemTableViewCell", bundle: nil)
        self.tableView.register(nib, forCellReuseIdentifier: "BLEDataItemTableViewCell")
    ...
    func requestSelectedProfile(category: String, profile_name: String) {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        if pickerView == profilePicker {
            if component == 0 {
                ...
                self.requestSelectedProfile(category: self.category, profile_name: self.device)
            }
            else {
                let selectedIndex = self.profilePicker.selectedRow(inComponent: 0)
